...
import { ArrowLeft, MessageCircle, MoreHorizontal, ThumbsUp, ThumbsDown } from 'lucide-react';
import { Topic, TopicReply, Leader } from '../types';
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center space-x-2 mb-1">
              <span className="font-semibold text-gray-900 text-sm">
                {currentLeader.id === reply.author.id ? 'You' : reply.author.name}
              </span>
              ...
              <div className="flex items-center space-x-2">
                ...
                >
                  ...
                  <span className="text-xs">
                    {reply.votes.filter(v => v.type === 'up').length}
                  </span>
                </button>
                <button
                ...
                >
                  <ThumbsDown size={14} />
                  <span className="text-xs">
                    {reply.votes.filter(v => v.type === 'down').length}
                  </span>
                </button>
              </div>
            ...
            <div className="flex space-x-3">
              ...
              <div className="flex-1">
                <textarea
                  ...
                  placeholder="Add your reply as a leader..."
...
const AdminTopicDetail: React.FC<AdminTopicDetailProps> = ({
  ...
  const { upvotes, downvotes } = getVoteCounts(topic.votes);
