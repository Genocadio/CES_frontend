...
type AdminSection = 'dashboard' | 'issues' | 'announcements' | 'topics' | 'profile';
        ...
        return (
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-medium text-gray-700">Administrative Level</label>
                  <p className="mt-1 text-sm text-gray-900 capitalize">{currentLeader.level} Leader</p>
                </div>
                <div>
    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className={`${sidebarCollapsed ? 'w-16' : 'w-64'} bg-white shadow-lg transition-all duration-300 ease-in-out fixed h-full z-10`}>
        ...
        <div className={`absolute bottom-0 ${sidebarCollapsed ? 'w-16' : 'w-64'} ${sidebarCollapsed ? 'p-2' : 'p-4'} border-t border-gray-200 bg-white transition-all duration-300 ease-in-out`}>
          ...
          <button
            onClick={() => logout()}
            className={`w-full flex items-center ${sidebarCollapsed ? 'justify-center' : 'px-3 py-2'} text-sm font-medium text-red-600 hover:bg-red-50 rounded-lg transition-colors ${sidebarCollapsed ? 'p-1' : 'p-2'} h-auto`}
          >
