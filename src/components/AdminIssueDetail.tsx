...
import { Issue, Leader, ResponseResponseDto, ResponseStatus, PostType, CommentRequestDto, IssueStatus, Urgency, Level } from '../types';
                      ...
                      {leaders.map((leader) => (
                        <div
                          ...
                          className={`p-2 cursor-pointer hover:bg-gray-100 ${
                            selectedLeader === leader.id ? 'bg-blue-100' : ''
                          }`}
                        >
                          ...
                          <div className="text-xs text-gray-500">
                            {leader.role} • {leader.location?.district}
                          </div>
                        </div>
                      ))}
                    </div>
