...
export const translations = {
  rw: {
    ...
    category: "Icyiciro",
    priority: "Ibanze",
    submitted: "Byaherejwe",
    attachments: "ibyo wakongeraho",
    assignReader: "Ohereza ku Umunyamabanga",
    searchLeaderByName: "Shakisha umunyamabanga ku izina",
    searching: "Birakagenda...",
    noLeadersFound: "Nta munyamabanga wabonetse",
    noDepartment: "Nta icyiciro",
    assignedTo: "Oherejwe kuri",
    ...
    profileInformation: "Amakuru yawe",
    profileDescription: "Amakuru yawe",
    nameCannotBeChanged: "Amazina ntabashoboka guhindurwa",
    emailCannotBeChanged: "Ineyili ntabashoboka guhindurwa",
    phoneCannotBeChanged: "Nimero ya telefoni ntibishoboka kuyihindura",
    ...
    english: "Icyongereza",
    french: "Igifaransa",
    makeProfilePublic: "Kora porofile yawe ",
    publicProfileDescription: "Iyo byakozwe, amazina yawe azaba aboneka ku ibibazo n'ibitekerezo",
    ...
    underReview: "Biri gukurikiranwa",
    ...
    passwordsDontMatch: "ijambo ry'ibanga ntago rihura",
    passwordTooShort: "Ijambo ry'ibanga rigenewe kuba ririmo inyuguti 6 cyangwa zirenze",
    accountExists: "Konti ifite iyi nimero ya telefoni irahari",
  ...
  en: {
    ...
    searchLeaderByName: "Search leader by name",
    searching: "Searching...",
  ...
  fr: {
    ...
    assignReader: "Assigner un Lecteur",
    searchLeaderByName: "Rechercher un leader par nom",
    searching: "Recherche...",
    noLeadersFound: "Aucun leader trouvé",
